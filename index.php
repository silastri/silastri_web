...
<body>
  ...
  <div id="angkatan" class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">
        Informasi pelatihan kerja berbasis kompetensi di UPT BLK Singosari
        Malang.
      </p>
  ...
  <div id="pendaftaran" class="px-4 py-5 my-5 text-center">
    ...
    <h2 class="display-5 fw-bold">Pendaftaran Gel. 5 (21-29 Juni) 2024</h2>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">
      ...
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        ...
        <a target="_blank" href="pages/pengumuman-seleksi.php"><button type="button" class="btn btn-success btn-lg px-4 disabled" disabled aria-disabled="true">
