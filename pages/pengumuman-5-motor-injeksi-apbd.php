...
<body>
  ...
  <h2 class="display-6 fw-bold text-center mb-5">
    Kejuruan Servis Sepeda Motor Injeksi (APBD)
  </h2>
  <div class="container">
    <div class="table-responsive">
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          <tr>
            <th scope="row">1</th>
            <td>MUHAMMAD RIZAL ARDIANSYAH</td>
            <td>30</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">2</th>
            <td>AHSANDY INDRA FAKRUDI</td>
            <td>08</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">3</th>
            <td>RIZKY HAFIDZ BAHTIAR </td>
            <td>36</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">4</th>
            <td>ABDURROCMAN IBNU HUSEN</td>
            <td>01</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">5</th>
            <td>FIRMANSYAH AFANDY</td>
            <td>14</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">6</th>
            <td>M. FAIZINAL IHSAN</td>
            <td>19</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">7</th>
            <td>MUCHAMMAD KHALIMUL MURTADHO</td>
            <td>28</td>
            <td>Lulus</td>
          </tr>
          <tr>
          ...
          <tr>
            <th scope="row">9</th>
            <td>CANDRES MEYLAND AGUSTA</td>
            <td>41</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">10</th>
            <td>SALMAN FARIS ARISKI</td>
            <td>42</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">11</th>
            <td>RIFO MASHUR MUARIF</td>
            <td>43</td>
            <td>Lulus</td>
          </tr>
          <tr>
            <th scope="row">12</th>
            <td>M.NUR HAUDIO M.</td>
            <td>44</td>
            <td>Lulus</td>
          </tr>
          <tr>
