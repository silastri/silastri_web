    ...
    <div class="justify-content-end collapse navbar-collapse" id="navbarNav">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="dropdown-item" href="../pages/informasi-kejuruan.php">Informasi Kejuruan</a>
            </li>
            <li class="dropdown-divider"></li>
            <li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
            aria-expanded="false">Pengumuman</a>
          <ul class="dropdown-menu">
            <li>
...
<!-- heading judul -->
<h1 class="p-1 pb-0 display-5 fw-bold text-center">
  SILASTRI UPT BLK SINGOSARI
</h1>
<p class="text-center">
  Sistem Layanan Pelatihan Singosari Terpadu & Terkini
</p>
<!-- /heading judul -->